...
////// 表格 //////
echo "<form id=\"adminform\"> <div class=\"table-responsive\"><table class=\"table table-bordered table-hover\"><tr><th class=\"ali\">ID</th><th  class=\"ali\">分组</th><th>标题</th><th>内容</th><th class=\"ali\">公开</th><th class=\"ali\">操作</th></tr>";
		//// $i是行数
		for ($i=0; $i < count($arr); $i++) { 
			...
			//$grouphtml = "<select style=\"width: 85%;\" onclick=\"group_js(".$id.")\" class=\"custom-select my-1 mr-sm-2\" id=\"group\" name=\"group\"><option selected value=\"\">".$group."</option>".$this->tgroup."</select>";
			$grouphtml = "<select style=\"width: 85%;\" onclick=\"group_js(".$id.")\" class=\"custom-select my-1 mr-sm-2\" id=\"group\" name=\"group\"><option  value=\"\"></option>".$this->tgroup."</select>";
			...
			//表格显示输出
			echo  "<tr><td class=\"ali\">".$id."</td><td  class=\"ali\">".$grouphtml."</td><td>".$tit."</td><td>".$cont."</td><td class=\"ali\">".$btn."</td><td class=\"ali\"><a onclick=\"DILOG.showtxt(".$id.")\" href=\"#\"><div data-target=\"#write\" data-toggle=\"modal\" >查看</div></a></td></tr>";
		}
