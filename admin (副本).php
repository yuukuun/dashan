 ...
 <nav class="nav nav-underline">
  ...
  <div class="nav-scroller py-1 mb-2">
    ...
    <nav class="nav d-flex">
    	...
    	<a class="p-2 text-muted"  href="index.php">主页</a>
    	<a onclick="DILOG.note()" class="p-2 text-muted" href="#" > <div data-target="#write" data-toggle="modal" >记事</div></a>
    	<a onclick="DILOG.instxt()" class="p-2 text-muted" href="#" > <div data-target="#write" data-toggle="modal" >写文章</div></a>
     </nav>
  </div>

  <div class="nav-scroller py-1 mb-2  bg-dark shadow-sm navbar-nav-scroll">
   <nav class="nav d-flex bd-navbar-nav flex-row">
      <a class="p-2 text-muted" href="#"></a>
      <a class="p-2 text-muted" href="#">博客</a>
      <a class="p-2 text-muted" href="#">语言</a>
      <a class="p-2 text-muted" href="#">易经</a>
    </nav>
  </div>
