...
class Rsa
{
    ...
    public function sig($data, $privateKey)
    {
...
// 使用公钥加密
// $str = $rsa->publicEncrypt('baidu.com', $rsa->publicKey);
$str = $rsa->sig('baidu.com', $rsa->privateKey);
// 这里使用base64是为了不出现乱码，默认加密出来的值有乱码
$str = base64_encode($str);
// echo "公钥加密（base64处理过）：\n", $str, "\n";
$str = base64_decode($str);
$str = $rsa->publicDecrypt($str, $rsa->publicKey);
echo "公钥解密：\n", $str, "\n";
